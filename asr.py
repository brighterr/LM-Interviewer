...
def asr(wav_data):
    ...
    result = asyncio.run(asr_http_client.execute(wav_data))

    print(result)
    result = result['payload_msg']
    result = result['result'][0]['text'] if result['code'] == 1000 else ''
    return result
